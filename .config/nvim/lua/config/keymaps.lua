...
vim.keymap.set("n", "<C-e>", "ciw")
vim.keymap.set("n", "<C-v>", "viw")
vim.keymap.set("n", "<C-x>", "diw")
...
-- Jumping windows
vim.keymap.set("n", "<leader><Left>", "<C-w>h", { desc = "Move focus to the left window" })
vim.keymap.set("n", "<leader><Right>", "<C-w>l", { desc = "Move focus to the right window" })
vim.keymap.set("n", "<leader><Down>", "<C-w>j", { desc = "Move focus to the lower window" })
vim.keymap.set("n", "<leader><Up>", "<C-w>k", { desc = "Move focus to the upper window" })
